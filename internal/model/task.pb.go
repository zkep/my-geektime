...
type Task struct {
	...
	// task name
	TaskName string `protobuf:"bytes,6,opt,name=task_name,json=taskName,proto3" json:"task_name,omitempty" gorm:"size:128;comment:task name"`
	// task type
	TaskType string `protobuf:"bytes,7,opt,name=task_type,json=taskType,proto3" json:"task_type,omitempty" gorm:"index;size:50;comment:task type"`
	// cover
	Cover string `protobuf:"bytes,8,opt,name=cover,proto3" json:"cover,omitempty" gorm:"comment:cover"`
	// raw
...
var fileDescriptor_ce5d8dd45b4a91ff = []byte{
	...
	,
}
