...
type SysDictBase struct {
	...
	// pkey
	Pkey string `protobuf:"bytes,3,opt,name=pkey,proto3" json:"pkey,omitempty" gorm:"index;comment:pkey"`
	// name
	Name string `protobuf:"bytes,4,opt,name=name,proto3" json:"name,omitempty" gorm:"index;size:100;comment:name"`
	// summary
	Summary string `protobuf:"bytes,5,opt,name=summary,proto3" json:"summary,omitempty" gorm:"type:text;comment:summary"`
	// content
	Content []byte `protobuf:"bytes,6,opt,name=content,proto3" json:"content,omitempty" gorm:"type:text;comment:content"`
	// sort
...
var fileDescriptor_4c89b6a76d7dcc8b = []byte{
	...
	,
}
